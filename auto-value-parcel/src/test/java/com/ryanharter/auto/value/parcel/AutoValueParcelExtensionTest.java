...
public class AutoValueParcelExtensionTest {
  ...
  @Test
  public void failWhenWriteToParcelAlreadyDefinedTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
            + "package test;\n"
            + "import android.os.Parcel;\n"
            + "import android.os.Parcelable;\n"
  ...
  @Test
  public void handlesAllParcelableTypes() {
  ...
  @Test
  public void usesProperClassLoader() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
            + "package test;\n"
            + "import java.util.Map;\n"
            + "import java.util.List;\n"
  ...
  @Test
  public void acceptsParcelableProperties() throws Exception {
  ...
  @Test
  public void throwsForInvalidMapType() throws Exception {
  ...
  @Test
  public void usesCustomParcelTypeAdapter() throws Exception {
  ...
  @Test
  public void handlesNestedTypeAdaptersOfSameName() throws Exception {
    JavaFileObject bar = JavaFileObjects.forSourceString("test.Bar", ""
            + "package test;\n"
            + "import java.util.Date;\n"
            + "import android.os.Parcel;\n"
  ...
  @Test
  public void handlesNullableWithParcelTypeAdapter() throws Exception {
    JavaFileObject bar = JavaFileObjects.forSourceString("test.Bar", ""
            + "package test;\n"
            + "import java.util.Date;\n"
            + "public class Bar {\n"
  ...
  @Test
  public void acceptsParcelableSubclassesTwiceRemoved() throws Exception {
  ...
  @Test
  public void addsSuppressWarningsAnnotationWhenListFieldExists() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
            + "package test;\n"
            + "import android.os.Parcelable;\n"
            + "import com.google.auto.value.AutoValue;\n"
  ...
  @Test
  public void addsSuppressWarningsAnnotationWhenMapFieldExists() {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", ""
            + "package test;\n"
            + "import android.os.Parcelable;\n"
            + "import com.google.auto.value.AutoValue;\n"
  ...
  @Test
  public void doesNotAddSuppressWarningsAnnotationWithoutMapOrList() {
